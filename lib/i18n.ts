...
The generated text will be auto-translated so you can publish in many languages instantly.
 - Example: “Announce that we’re launching a new DeFi protocol.”`,
  ...
  ko: {
    ...
    directInput: '직접 입력',
    aiGenerate: 'AI 생성',
    placeholder: `전하고 싶은 내용을 자유롭게 입력하세요.
입력한 문장은 선택한 언어로 자동 번역되어 언어별 카드로 생성됩니다.
이미지를 업로드하면 각 언어별 카드에도 자동으로 포함됩니다.
 - 예: “오늘 우리 프로젝트의 로드맵 2.0을 공개합니다!”`,
    chars: '글자',
    ...
    describeTopic: `AI가 대신 작성할 글의 주제나 키워드를 입력하세요.
한두 줄의 간단한 설명만 있어도 자연스러운 원문을 생성해드립니다.
생성된 글은 자동 번역되어 다양한 언어로 바로 게시할 수 있습니다.
 - 예: “새로운 DeFi 프로토콜 출시 소식을 알려줘.”`,
    generate: '생성하기',
    generating: '생성 중...',
    preview: '미리보기',
    style: '스타일',
...
ข้อความที่สร้างเสร็จจะถูกแปลอัตโนมัติ เพื่อให้คุณโพสต์ได้หลายภาษาในครั้งเดียว
 - ตัวอย่าง: “ช่วยประกาศข่าวการเปิดตัวโปรโตคอล DeFi ตัวใหม่ให้หน่อย”`,
    ...
    walletNotConnectedLabel: 'ยังไม่เชื่อมต่อกระเป๋าเงิน',
